...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
      children: [
        Text(progressName, style: TextStyle(color: Colors.white.withOpacity(0.65), fontSize: 10),),
     Row(
       children:[
         Text("$value 0 %", style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 10),),
